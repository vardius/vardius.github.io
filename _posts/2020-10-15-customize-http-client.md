...
Service **B** custom transport sets headers for content type only, because we are using _oauth2_ HTTP client, they already append token and handle auto-refresh as necessary for us.
